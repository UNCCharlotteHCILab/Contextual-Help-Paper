...
SOUPS 2016 conference paper in either LaTeX or Microsoft Word Format.

The SOUPS 2016 conference format is the ACM SIG Proceedings Template
...
If you use LaTeX to create your paper, SOUPS 2016 recommends that you
use pdflatex directly. 

SOUPS 2016 specifically recommends against using latex to create a DVI
